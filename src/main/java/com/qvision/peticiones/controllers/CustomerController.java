...
public class CustomerController {
	...
	@GetMapping("/clientes/{tipoIdentificacion}/{numeroIdentificacion}")
	public ResponseEntity<?> getOneByIdenticiation(@PathVariable("tipoIdentificacion") String tipoIdentificacion,
	...
	public ResponseEntity<?> guardar(@Valid @RequestBody Customer custom) {
		try {
	...
	public ResponseEntity<?> modify(@Valid @RequestBody Customer custom, @PathVariable("id") Long id) {
		try {
			Optional<Customer> optCustm;
